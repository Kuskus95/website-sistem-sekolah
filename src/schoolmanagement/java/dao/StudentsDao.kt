        ...
        get() {
            ...
            return jdbcTemplate!!.query<List<Students>>(sql) { rs ->
                ...
                while (rs.next()) {
                    ...
                    students?.Nim = rs.getString(4)
                    students?.mobileNumber = rs.getString(5)
                    students?.email = rs.getString(6)
                    students?.location = rs.getString(7)
                    students?.gender = rs.getString(8)
                    students?.registrationDate = rs.getString(9)
                    students?.level = rs.getString(10)
                    students?.department = rs.getString(11)
                    students?.courseName = rs.getString(12)
                    students?.amount = rs.getString(13)
                    students?.balance = rs.getString
